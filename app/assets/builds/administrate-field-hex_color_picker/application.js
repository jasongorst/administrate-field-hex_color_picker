(() => {
  ...
  var require_jquery_minicolors = __commonJS({
    "node_modules/jquery-minicolors/jquery.minicolors.js"(exports, module) {
      (function(factory) {
        if (typeof define === "function" && define.amd) {
            ...
            switch (method) {
              ...
              case "value":
                if (data === void 0) {
                  ...
                  $2(this).each(function() {
                    updateFromInput($2(this).val(data));
                  });
                }
                return $2(this);
              default:
        ...
        function init(input, settings) {
          var minicolors = $2('<div class="minicolors" />'), defaults = $2.minicolors.defaults;
        ...
        function hide() {
          $2(".minicolors-focus").each(function() {
            var minicolors = $2(this), input = minicolors.find(".minicolors-input"), panel = minicolors.find(".minicolors-panel"), settings = input.data("minicolors-settings");
        ...
        function rgbObject(input) {
          var hex = parseHex($2(input).val(), true), rgb = hex2rgb(hex), opacity = $2(input).attr("data-opacity");
          if (!rgb)
            return null;
          if (opacity !== void 0)
        ...
        $2(document).on("mousedown.minicolors touchstart.minicolors", function(event) {
          ...
          var target = $2(this);
          event.preventDefault();
          $2(document).data("minicolors-target", target);
          move(target, event, true);
        }).on("mousemove.minicolors touchmove.minicolors", function(event) {
          var target = $2(document).data("minicolors-target");
          if (target)
            move(target, event);
          ...
          var input = $2(this), settings = input.data("minicolors-settings");
          if (!input.data("minicolors-initialized"))
            return;
